...
class RegisterStudentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'user_name' => ['required', 'string', 'min:3', 'max:255', 'unique:users,user_name', 'regex:/^[a-zA-Z0-9_-]+$/'],
    ...
    public function messages(): array
    {
        return [
            ...
            'exam_id.required' => 'نوع الاختبار مطلوب',
            'exam_id.exists' => 'نوع الاختبار غير موجود',
            'exam_date.after' => 'تاريخ الاختبار يجب أن يكون في المستقبل',
        ];
    }
}
