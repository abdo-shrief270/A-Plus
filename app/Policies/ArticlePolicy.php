...
class ArticlePolicy
{
    ...
    {
        return $admin->can('view_any_article');
    }
    ...
    {
        return $admin->can('create_article');
    }
    ...
    {
        return $admin->can('update_article');
    }
    ...
    {
        return $admin->can('delete_article');
    }
    ...
    {
        return $admin->can('delete_any_article');
    }
     ...
     */
    public function replicate(Admin $admin, Article $article): bool
    {
