...
class CoursePolicy
{
    ...
    {
        return $admin->can('view_any_course');
    }
    ...
    {
        return $admin->can('create_course');
    }
    ...
    {
        return $admin->can('update_course');
    }
    ...
    {
        return $admin->can('delete_course');
    }
    ...
    {
        return $admin->can('delete_any_course');
    }
