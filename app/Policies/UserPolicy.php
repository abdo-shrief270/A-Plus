...
class UserPolicy
{
    ...
    {
        return $admin->can('view_any_student');
    }
    ...
    {
        return $admin->can('create_student');
    }
    ...
    {
        return $admin->can('update_student');
    }
    ...
    {
        return $admin->can('delete_student');
    }
    ...
    {
        return $admin->can('delete_any_student');
    }
