...
class LessonPolicy
{
    ...
    {
        return $admin->can('view_any_lesson');
    }
    ...
    {
        return $admin->can('create_lesson');
    }
    ...
    {
        return $admin->can('update_lesson');
    }
    ...
    {
        return $admin->can('delete_lesson');
    }
    ...
    {
        return $admin->can('delete_any_lesson');
    }
     ...
     */
    public function replicate(Admin $admin, Lesson $lesson): bool
    {
